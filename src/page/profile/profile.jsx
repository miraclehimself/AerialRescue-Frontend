...
<Stack w="68%" >
       ...
       <Text  fontWeight="400" fontSize={calculateResponsiveFontSize(1)} style={styles.heading2}>Full Name: </Text>
        <Text fontWeight="800"   fontSize={calculateResponsiveFontSize(1)} style={styles.heading}>Ajani Ben D.</Text>
       ...
       <Text  fontWeight="400" fontSize={calculateResponsiveFontSize(1)} style={styles.heading2}>Email: </Text>
        <Text fontWeight="800"    fontSize={calculateResponsiveFontSize(1)} style={styles.heading}>ajaniben123456@gmail.com </Text>
